...
ONTOLOGY = {
    ...
    "USES": {
        "PERSON": ["PHONE", "UPI_ID", "BANK_ACCOUNT", "VEHICLE", "WEAPON", "ORGANIZATION", "LOCATION"],
        "ORGANIZATION": ["PHONE", "BANK_ACCOUNT", "LOCATION"]
    },
    "OWNS": {
        "PERSON": ["VEHICLE", "BANK_ACCOUNT", "UPI_ID", "ORGANIZATION", "PHONE", "LOCATION", "WEAPON"],
        "ORGANIZATION": ["LOCATION", "VEHICLE", "BANK_ACCOUNT"]
    },
    # Communication
    "COMMUNICATES_WITH": {
    ...
    "LOCATED_AT": {
        ...
        "PHONE": ["LOCATION"],
        "EVENT": ["LOCATION"],
        "LOCATION": ["LOCATION"],  # containment: building inside city
        "CASE": ["LOCATION"]
    },
    # Association / Affiliation
    "ASSOCIATED_WITH": {
        "PERSON": ["PERSON", "ORGANIZATION", "EVENT", "VEHICLE"],
        "ORGANIZATION": ["PERSON", "ORGANIZATION", "EVENT"]
    },
    "AFFILIATED_WITH": {
    ...
    # Financial
    "TRANSFERRED_TO": {
        "PERSON": ["UPI_ID", "BANK_ACCOUNT", "PERSON", "ORGANIZATION"],
        "UPI_ID": ["UPI_ID", "BANK_ACCOUNT", "PERSON"],
        "BANK_ACCOUNT": ["BANK_ACCOUNT", "UPI_ID", "PERSON", "ORGANIZATION"],
        "ORGANIZATION": ["BANK_ACCOUNT", "PERSON", "ORGANIZATION"]
    },
    "LINKED_TO": {
    ...
    # Criminal / Event participation
    "INVOLVED_IN": {
        "PERSON": ["EVENT", "ORGANIZATION", "LOCATION", "PERSON"],
    ...
    "ACCUSED_IN": {
        "PERSON": ["EVENT", "LOCATION", "ORGANIZATION", "CASE"],
        "ORGANIZATION": ["EVENT", "CASE"]
    },
    "ARRESTED_IN": {
        "PERSON": ["LOCATION", "EVENT", "CASE"]
    },
    "ARRESTED_WITH": {
        "PERSON": ["PERSON"]
    },
    ...
    "INVESTIGATED": {
        "ORGANIZATION": ["PERSON", "ORGANIZATION", "EVENT", "CASE"],
        "PERSON": ["PERSON", "ORGANIZATION", "EVENT", "CASE"]
    },
    "INITIATED_INVESTIGATION": {
        "ORGANIZATION": ["EVENT", "PERSON", "ORGANIZATION", "CASE"],
        "PERSON": ["EVENT", "PERSON", "CASE"]
    },
    "CONDUCTS_INVESTIGATION": {
        "ORGANIZATION": ["EVENT", "PERSON"]
    },
    "CONDUCTS_INVESTIGATION_FOR": {
    ...
    # Family / Social
    "BROTHER_OF": {"PERSON": ["PERSON"]},
    "FAMILY_OF": {"PERSON": ["PERSON"]},
    "KNOWN_ASSOCIATE_OF": {"PERSON": ["PERSON"]},
    # Regulatory
    "ISSUED_REGULATORY_NOTIFICATION_TO": {
        "ORGANIZATION": ["ORGANIZATION", "PERSON"]
    },
    "OPERATES_AS": {
        "ORGANIZATION": ["ORGANIZATION"],
...
def validate_relationship(db: Session, request: ValidationRequest) -> ValidationResponse:
    ...
    if v1_enabled:
        ...
        if request.relationship_type in RELATIONSHIP_TO_EVENT_MAPPING:
            ...
            # Dynamic remapping for LOCATED_AT based on source type
            if request.relationship_type == "LOCATED_AT" and ont_src == "netra:Event":
                ont_rel = "netra:OCCURRED_AT"
            ...
            if not ont_rel:
                ...
                if res.is_valid:
                    ontology_valid = True
                elif request.relationship_type == "LOCATED_AT" and ont_src == "netra:Location" and ont_tgt == "netra:Location":
                    # Hardcode exception for containment Location -> Location since V1 ontology lacks it
                    ontology_valid = True
                else:
