                    ...
                    <div className="max-w-container-max mx-auto">
                        <div className="mb-6 border-b border-outline-variant pb-4">
                            <h1 className="text-2xl md:text-3xl font-bold text-primary flex items-center gap-2">
                                <span className="material-symbols-outlined text-3xl">person_search</span> Criminal Profiling
                            </h1>
                            <p className="text-on-surface-variant mt-2 text-sm">Select a case to view suspect profiles, risk assessments, and behavioral indicators.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                            {cases.map((c) => (
                                <CaseCard 
                                    ...
                                    actionPath={`/cases/${c.id}/profiling`} 
                                />
                            ))}
                        </div>
                    </div>
